...
public static class RandomWalk_
{
    public static HashSet<Vector2Int> Walk(Vector2Int startPosition, int walkLength)
    {
        ...
        {
            var newPosition = previousPosition + Direction2D_.GetRandomDirection();
    ...
    public static List<Vector2Int> CorridorWalk(Vector2Int startPosition, int corridorLength)
    {
        ...
        var direction = Direction2D_.GetRandomDirection();
...
public static class Direction2D_
{
