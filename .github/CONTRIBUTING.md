Thanks for taking the time to contribute to this project! Make sure you follow the steps given in the [readme](/README.md#getting-started) to setup the project locally for development.
